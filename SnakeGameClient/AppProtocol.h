...
typedef enum RECV_OPCODE {
	...
	C_RECV_NEW_TAIL_POPULATE = 603, // NEW TAIL POPULATE ON THE MAP - MAXIMUM 3, (X,Y) INFO
...
typedef enum SEND_OPCODE {
	...
	C_SEND_GAME_START_REQ = 200,
	C_SEND_TURN_RIGHT = 201,
	C_SEND_TURN_LEFT = 202,
	C_SEND_TURN_UP = 203,
	C_SEND_TURN_DOWN = 204,
	C_SEND_NEW_TAIL_REQUEST = 205 // GAME THREAD WILL REQUEST IT TO SERVER
} SEND_OPCODE;
